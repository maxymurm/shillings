...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Available token abilities for the Shillings accounting application.
    | These can be assigned when creating API tokens for users.
    |
    */
    ...
    'abilities' => [
        ...
        'transactions:post' => 'Post transactions',
